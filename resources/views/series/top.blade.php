...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            Découvrez les séries les mieux notées du moment, sélectionnées pour vous
        </p>
    </div>
    ...
    @if(isset($seriesData['results']) && count($seriesData['results']) > 0)
        @if(count($seriesData['results']))
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Les autres séries du top</h2>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @foreach ($seriesData['results'] as $index => $series)
                    <div class="relative">
    ...
    @else
        <div class="text-center py-16">
            ...
            <p class="text-gray-600 mb-8">
                Nous n'avons trouvé aucune série pour le moment.
            </p>
