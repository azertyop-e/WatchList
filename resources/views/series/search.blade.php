        ...
        @if($totalPages > 1)
            <div class="mt-8 mb-4 flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                <nav aria-label="Pagination" class="flex justify-center items-center text-gray-600">
                    @if($currentPage > 1)
                        <a href="{{ route('series.search', ['query' => $query, 'page' => $currentPage - 1]) }}" 
                    ...
                    @if($showFirst)
                        ...
                        @else
                            <a href="{{ route('series.search', ['query' => $query, 'page' => 1]) }}" 
                    ...
                    @if($showLast && $totalPages != 1)
                        ...
                        @else
                            <a href="{{ route('series.search', ['query' => $query, 'page' => $totalPages]) }}" 
